#
#  Be sure to run `pod spec lint darkly.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "Darkly/**/*.{h,m}", "Darkly/*.{h,m}"
  ...
  s.subspec 'Core' do |ss|
    ...
    ss.dependency 'EventSource', :git => 'https://github.com/launchdarkly/ios-eventsource.git'
  end
end
