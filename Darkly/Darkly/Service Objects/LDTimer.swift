...
protocol TimeResponding {
    ...
    init(withTimeInterval: TimeInterval, repeats: Bool, execute: @escaping () -> Void)
...
final class LDTimer: TimeResponding {
    ...
    convenience init(withTimeInterval timeInterval: TimeInterval, repeats: Bool, execute: @escaping () -> Void) {
        self.init(withTimeInterval: timeInterval, repeats: repeats, fireQueue: DispatchQueue.main, execute: execute)
    }
