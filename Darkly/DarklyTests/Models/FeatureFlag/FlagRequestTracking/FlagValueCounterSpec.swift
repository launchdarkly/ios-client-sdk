...
extension Dictionary where Key == String, Value == Any {
    ...
    var valueCounterVersion: Int? { return self[FlagValueCounter.CodingKeys.version.rawValue] as? Int }
    var valueCounterIsUnknown: Bool? { return self[FlagValueCounter.CodingKeys.unknown.rawValue] as? Bool }
    var valueCounterCount: Int? { return self[FlagValueCounter.CodingKeys.count.rawValue] as? Int }
}
