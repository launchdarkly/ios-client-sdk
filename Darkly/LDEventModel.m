...
-(NSDictionary *)dictionaryValueUsingConfig:(LDConfig*)config {
    ...
    self.user ? [dictionary setObject:[self.user dictionaryValueWithFlagConfig:YES includePrivateAttributes:NO privateAttributesFromConfig:config.privateUserAttributes] forKey: kUserKey] : nil;
