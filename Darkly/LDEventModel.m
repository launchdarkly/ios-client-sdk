...
- (void)encodeWithCoder:(NSCoder *)encoder {
    ...
    [encoder encodeBool:[(NSNumber *)self.featureKeyValue boolValue] forKey:kFeatureKeyValueKey];
    [encoder encodeBool:[(NSNumber *)self.isDefault boolValue] forKey:kIsDefaultKey];
