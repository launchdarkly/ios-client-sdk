...
private func key(_ flagKey: LDFlagKey) -> EvaluationExposureKey {
    return EvaluationExposureKey(environmentId: "environment-id",
                                 flagKey: flagKey,
                                 variation: 1,
                                 flagVersion: 2,
    ...
    override func spec() {
        describe("EvaluationExposureDeduper") {
            ...
            it("reports again when only the flag value changes") {
                let deduper = EvaluationExposureDeduper(window: 10)
                let first = EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: 1,
                                                  flagVersion: 2,
                                                  fullyQualifiedContextKey: "user-key", value: .string("first"))
                let second = EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: 1,
                                                   flagVersion: 2,
            ...
            it("tracks the same flag separately per environment") {
                let deduper = EvaluationExposureDeduper(window: 10)
                let primary = EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: 1,
                                                    flagVersion: 2,
                                                    fullyQualifiedContextKey: "user-key")
                let secondary = EvaluationExposureKey(environmentId: "other-environment-id", flagKey: "flag", variation: 3,
                                                      flagVersion: 4,
                                                      fullyQualifiedContextKey: "user-key")
        ...
        describe("EvaluationExposureKey") {
            let base = EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: 1,
                                             flagVersion: 2, fullyQualifiedContextKey: "user-key")
            it("distinguishes every component") {
                expect(base) == EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: 1,
                                                      flagVersion: 2,
                                                      fullyQualifiedContextKey: "user-key")
                expect(base) != EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: 1,
                                                      flagVersion: 2,
                                                      fullyQualifiedContextKey: "user-key", value: .string("value"))
                expect(base) != EvaluationExposureKey(environmentId: "environment-id", flagKey: "other-flag", variation: 1,
                                                      flagVersion: 2,
                                                      fullyQualifiedContextKey: "user-key")
                expect(base) != EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: 3,
                                                      flagVersion: 2,
                                                      fullyQualifiedContextKey: "user-key")
                expect(base) != EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: 1,
                                                      flagVersion: 4,
                ...
                expect(base) != EvaluationExposureKey(environmentId: "other-environment-id", flagKey: "flag", variation: 1,
                                                      flagVersion: 2,
                                                      fullyQualifiedContextKey: "user-key")
            }
            it("tells a missing variation and version apart from any present one") {
                let missing = EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: nil,
                                                    flagVersion: nil,
                                                    fullyQualifiedContextKey: "user-key")
                expect(missing) != base
                expect(missing) == EvaluationExposureKey(environmentId: "environment-id", flagKey: "flag", variation: nil,
                                                         flagVersion: nil,
                                                         fullyQualifiedContextKey: "user-key")
            }
