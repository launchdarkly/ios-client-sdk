...
+(instancetype)stubForFlagKey:(NSString*)flagKey {
    return [LDFlagConfigValue stubForFlagKey:flagKey useAlternateValue:NO];
}

+(instancetype)stubForFlagKey:(NSString*)flagKey useAlternateValue:(BOOL)useAlternateValue {
    LDFlagConfigValue *flagConfigValue = [[LDFlagConfigValue alloc] init];
    flagConfigValue.value = useAlternateValue ? [LDFlagConfigValue differentValueForFlagKey:flagKey] : [LDFlagConfigValue defaultValueForFlagKey:flagKey];
    flagConfigValue.variation = [LDFlagConfigValue variationWithAlternateValue:useAlternateValue];
    flagConfigValue.modelVersion = [LDFlagConfigValue modelVersionWithAlternateValue:useAlternateValue];
    flagConfigValue.flagVersion = [LDFlagConfigValue flagVersionWithAlternateValue:useAlternateValue];
...
+(NSInteger)variationWithAlternateValue:(BOOL)useAlternateValue {
    return useAlternateValue ? 3 : 2;
}

+(NSInteger)modelVersionWithAlternateValue:(BOOL)useAlternateValue {
    return useAlternateValue ? 3 : 2;
}

+(NSNumber*)flagVersionWithAlternateValue:(BOOL)useAlternateValue {
    return useAlternateValue ? @(2) : @(1);
}
